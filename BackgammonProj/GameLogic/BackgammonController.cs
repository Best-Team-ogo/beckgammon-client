...
namespace BackgammonLogic
{
    public class BackgammonController
    {
        ...
        private static BackgammonController backgammon =null;

        public static BackgammonController Singlton
        {
            get
            {
                if (backgammon == null)
                    backgammon = new BackgammonController();
                return backgammon;
            }
        }

        private BackgammonController()
        {
        ...
        public List<int> GetOptionsForInitialMove(int index)
        {
            if (_RedPlayer.IsMyTurn == true)
            {
                return _RedPlayer.AvailableMoves(GameBoard, GameDice, index);
            }
            else
            {
                return _BlackPlayer.AvailableMoves(GameBoard, GameDice, index);
            }
        }

        public List<int> GetOptionsForInitialSet()
        {
            if (_RedPlayer.IsMyTurn == true)
            {
                return _RedPlayer.AvailableMoves(GameBoard, GameDice,PlayerInitialTriangleChoice);
            }
            else
            {
                return _BlackPlayer.AvailableMoves(GameBoard, GameDice,PlayerInitialTriangleChoice);
            }
        }

        public List<int> GetOptionsForBarOff()
        {
            if (_RedPlayer.IsMyTurn == true)
            {
                return _RedPlayer.AvailableMovesBarOff(GameBoard, GameDice);
            }
            else
            {
                return _BlackPlayer.AvailableMovesBarOff(GameBoard, GameDice);
            }
        }
