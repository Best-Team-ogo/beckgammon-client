...
namespace BackgammonProj.Tools
{
    class PacketWriter
    {
        ...
        /// </summary>
        /// <param name="@string">The string to write</param>
        public void WriteCommonString(String @string)
        {
        ...
        private void WriteHexString(String hexString)
        {
        ...
        public void SetCommonString(long index, string @string)
        {
            long oldIndex = _buffer.Position;
            _buffer.Position = index;
            WriteCommonString(@string);
            _buffer.Position = oldIndex;
        }
